...
export const MODEL_PROVIDERS: ModelProvider[] = [
  ...
  },
  {
    ...
    summary: { zh: "轻量双语、零样本克隆和 Apache-2.0 方向更友好；建议先按官方 README 手动安装。", en: "Lightweight bilingual zero-shot cloning with a friendlier Apache-2.0 direction; manual setup from the official README is recommended first." },
    bestFor: { zh: "轻量 / 双语 / 商用友好", en: "Lightweight / bilingual / commercial-friendly" },
    installDifficulty: { zh: "手动安装", en: "Manual setup" },
